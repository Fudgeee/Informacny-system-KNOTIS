    ...
    <div class="kontaktne_udaje">
        <form action="{{route('update_kontaktne_info')}}" method="post">
            ...
            <div class="kontakt_info_l">
                ...
                <div class="kontakt_info_item">Podklady pro DPP: <!--TODO-->
                ...
                <div class="kontakt_info_item">Podklady pro Stip: <!--TODO-->
            ...
            <!--HIDDEN-->
                <div class="kontakt_info_item">
                    <div class="kontakt_info_item_span_add">
                ...
                <div class=" kontakt_info_hidden">
                    <div class="kontakt_info_item">
                        ...
                        <input type="text" size="25" maxlength="255" name="upravFacebook" title="Váš kontaktní Facebook účet" value="{{$data->facebook}}">
                    </div>
                    <div class="kontakt_info_item">
                        <div class="kontakt_info_item_span">Discord:</div>                   
                        <input type="text" size="25" maxlength="255" name="upravDiscord" title="Váš kontaktní Discord účet" value="{{$data->discord}}">
                    </div>
                    <div class="kontakt_info_item">
                        <div class="kontakt_info_item_span">Skype:</div>      
                        <input type="text" size="25" maxlength="127" name="upravSkype" title="Váš kontaktní Skype účet" value="{{$data->skype}}">             
                    </div>
                    <div class="kontakt_info_item">
                        <div class="kontakt_info_item_span">ICQ:</div>  
                        <input type="text" size="25" maxlength="15" name="upravIcq" title="Váše kontaktní ICQ" value="{{$data->icq}}">                 
                    </div>
                    <div class="kontakt_info_item">
                        <div class="kontakt_info_item_span">Jabber:</div>                   
                        <input type="text" size="25" maxlength="127" name="upravJabber" title="Váš kontaktní jabber účet" value="{{$data->jabber}}">
                    </div>
                </div>
            <!---------->
                <div class="kontakt_info_item">
                    <div class="kontakt_info_item_span_add">
                        <a href="#" onclick="toggleDppInfo()">Podklady pro DPP</a> <!--TODO-->
                    </div>
                </div>
                <div class="kontakt_info_item">
                    <div class="kontakt_info_item_span_add">
                        <a href="#" onclick="toggleStipInfo()">Podklady pro Stipendium</a> <!--TODO-->
                    </div>
                </div>
            <!--HIDDEN-->
