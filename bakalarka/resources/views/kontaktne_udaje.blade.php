...
<script>
    ...
    function addInputEmail(idSkupiny){
        ...
        html += '<td><input type="text" size="1" name="id[]" class="hidden" value=""><input type="text" style="outline:none; cursor:default; font-weight:500; background:none; border:none; padding:0px; width:160px" size="13" maxlength="255" name="typ[]" title="TODO" value="Mail" readonly><input type="text" style="margin-right:4px" size="25" maxlength="255" name="hodnota[]" title="{{__('Váš Gmail účet nebo školní e-mail')}}" value=""><input type="text" class="autocomplete-input-popis" style="margin-right:5px" size="25" maxlength="255" name="popis[]" title="TODO" value="" placeholder="popis"><a href="#" onclick="deleteInput(this);return false;"><img src="red-x.gif" style="width:20px" title="TODO" alt="TODO"/></a></td>';
    ...
    function addInputTelefon(idSkupiny){
        var html = "";
        var row	= document.getElementById(idSkupiny).insertRow(-1);     
        html += '<td><input type="text" size="1" name="id[]" class="hidden" value=""><input type="text" style="outline:none; cursor:default; font-weight:500; background:none; border:none; padding:0px; width:160px" size="13" maxlength="255" name="typ[]" title="TODO" value="Telefon" readonly><input type="text" style="margin-right:4px" size="25" maxlength="255" name="hodnota[]" title="{{__('Váš kontaktní telefon')}}" value=""><input type="text" class="autocomplete-input-popis" style="margin-right:5px" size="25" maxlength="255" name="popis[]" title="TODO" value="" placeholder="popis"><a href="#" onclick="deleteInput(this);return false;"><img src="red-x.gif" style="width:20px" title="TODO" alt="TODO"/></a></td>';
        // vlozeni HTML kodu do znacky
        row.innerHTML = html;
        initAutocompleteInputs();
    }
    ...
    function addInputOther(idSkupiny){
        var html = "";
        var row	= document.getElementById(idSkupiny).insertRow(-1);     
        html += '<td><input type="text" size="1" name="id[]" class="hidden" value=""><input type="text" class="autocomplete-input" style="margin-right:5px" size="13" maxlength="255" name="typ[]" id="typ" title="TODO" value="" placeholder="typ kontaktu"><div id="typList"></div><input type="text" style="margin-right:4px" size="25" maxlength="255" name="hodnota[]" title="TODO" value=""><input type="text" class="autocomplete-input-popis" style="margin-right:5px" size="25" maxlength="255" name="popis[]" title="TODO" value="" placeholder="popis"><a href="#" onclick="deleteInput(this);return false;"><img src="red-x.gif" style="width:20px" title="TODO" alt="TODO"/></a></td>';
        // vlozeni HTML kodu do znacky
        row.innerHTML = html;
        initAutocompleteInputs();
    }
                ...
                <table id="emaily">
                    <tr>
                        <td>
                            ...
                            <input type="text" class="autocomplete-input-popis" size="25" maxlength="255" name="mail_popis" title="TODO" value="{{$data->gmail_popis}}" placeholder="popis">
                ...
                <table id="telefony">
                    <tr>
                        <td>
                            ...
                            <input type="text" class="autocomplete-input-popis" size="25" maxlength="255" name="telefon_popis" title="TODO" value="{{$data->telefon_popis}}" placeholder="popis">
